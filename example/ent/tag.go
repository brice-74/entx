...
// was not loaded in eager-loading.
func (e TagEdges) ArticleTagOrErr() ([]*ArticleTag, error) {
	if e.loadedTypes[1] {
...
// QueryArticleTag queries the "article_tag" edge of the Tag entity.
func (t *Tag) QueryArticleTag() *ArticleTagQuery {
	return NewTagClient(t.config).QueryArticleTag(t)
}
