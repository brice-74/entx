...
func (atq *ArticleTagQuery) QueryArticle() *ArticleQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(articletag.Table, articletag.ArticleColumn, selector),
...
func (atq *ArticleTagQuery) QueryTag() *TagQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(articletag.Table, articletag.TagColumn, selector),
...
func (atq *ArticleTagQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(articletag.Table, articletag.Columns, nil)
	_spec.From = atq.sql
...
func (q *ArticleTagQuery) AppendInterceptors(inters ...Interceptor) *ArticleTagQuery {
	q.inters = append(q.inters, inters...)
	return q
}

// Modify adds a query modifier for attaching custom logic to queries.
func (atq *ArticleTagQuery) Modify(modifiers ...func(s *sql.Selector)) *ArticleTagSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (ats *ArticleTagSelect) Modify(modifiers ...func(s *sql.Selector)) *ArticleTagSelect {
