...
func (ac *ArticleCreate) SetNillablePublished(b *bool) *ArticleCreate {
	if b != nil {
		ac.SetPublished(*b)
	}
	return ac
...
func (ac *ArticleCreate) check() error {
	...
	if _, ok := ac.mutation.Published(); !ok {
		return &ValidationError{Name: "published", err: errors.New(`ent: missing required field "Article.published"`)}
	}
